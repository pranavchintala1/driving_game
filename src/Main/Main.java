 ...
 * --potentially rewriting code to separate the car into a separate object file {In Progress}
 * --chunk rendering algorithm? useful for larger tracks and decreases load times
 *
